...
this.cosa=(-Math.pow(this.a,2)+Math.pow(this.b,2)+Math.pow(this.c,2))/(2*this.b*this.c);
this.cosb=(Math.pow(this.a,2)-Math.pow(this.b,2)+Math.pow(this.c,2))/(2*this.a*this.c);
this.cosy=(Math.pow(this.a,2)+Math.pow(this.b,2)-Math.pow(this.c,2))/(2*this.a*this.b);
...
MyTriangle.prototype.initBuffers = function () {
	...
	this.indices = [
       ...
       this.texCoords=[
       this.c-this.a*this.cosb,this.cosb,
       0,0,
       this.c,0
